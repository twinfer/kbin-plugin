...
func (this *TermStrzUtf16V1) Read(io *kaitai.Stream, parent interface{}, root *TermStrzUtf16V1) (err error) {
	this._io = io
	this._parent = parent
	this._root = root
	...
	this.S1 = tmp2
	tmp3, err := this._io.ReadBytesTerm(0, false, false, true)
	if err != nil {
		return err
	}
	...
	tmp6, err := this._io.ReadBytesTerm(0, true, true, true)
	if err != nil {
		return err
	}
