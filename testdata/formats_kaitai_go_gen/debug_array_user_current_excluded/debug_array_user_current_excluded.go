...
package debug_array_user_current_excluded
...
func (this *DebugArrayUserCurrentExcluded) Read(io *kaitai.Stream, parent interface{}, root *DebugArrayUserCurrentExcluded) (err error) {
	this._io = io
	this._parent = parent
	this._root = root
