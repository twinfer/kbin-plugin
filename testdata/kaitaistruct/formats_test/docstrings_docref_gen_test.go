...
import (
	...
	// The alias helps avoid name collisions if docstrings_docref is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForDocstringsDocref(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForDocstringsDocref(t *testing.T, data any) map[string]any {
...
func TestParse_DocstringsDocref(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "docstrings_docref.ksy")
	ksySchema := loadKsySchemaForDocstringsDocref(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for docstrings_docref, skipping detailed parse tests.")

}

func TestSerialize_DocstringsDocref(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "docstrings_docref.ksy")
	ksySchema := loadKsySchemaForDocstringsDocref(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for docstrings_docref, skipping detailed serialize tests.")
