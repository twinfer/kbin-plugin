...
func TestParse_Enum0(t *testing.T) {
	// Load schema
	ksyPath := filepath.Join("../../../test/formats", "enum_0.ksy")
	...
	if pet2_val, ok := customMap["Pet2"]; ok {
		assert.EqualValues(t, Enum0_Animal__Chicken, pet2_val)
	} else {
...
func TestSerialize_Enum0(t *testing.T) {
	...
	reparsed := enum_0_kaitai.NewEnum0()
	...
	cmpOpts := []cmp.Option{
		...
		cmpopts.IgnoreFields(enum_0_kaitai.Enum0{}, "_io", "_parent", "_root"),
		cmpopts.EquateEmpty(),
	}
...
// structToMapEnum0 converts KSC struct to map for serializer
func structToMapEnum0(t *testing.T, data any) map[string]any {
	// Use reflection to handle KSC structs with method-based values
	return structToMapReflectiveEnum0(t, data)
}

// structToMapReflectiveEnum0 uses reflection to convert KSC structs including method calls
func structToMapReflectiveEnum0(t *testing.T, data any) map[string]any {
	...
	for i := 0; i < val.NumField(); i++ {
		...
		case reflect.Ptr:
			if !fieldVal.IsNil() {
				...
				subMap := structToMapReflectiveEnum0(t, fieldVal.Interface())
