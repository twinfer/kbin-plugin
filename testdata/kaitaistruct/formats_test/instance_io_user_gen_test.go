...
import (
	...
	// The alias helps avoid name collisions if instance_io_user is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForInstanceIoUser(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForInstanceIoUser(t *testing.T, data any) map[string]any {
...
func TestParse_InstanceIoUser(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "instance_io_user.ksy")
	ksySchema := loadKsySchemaForInstanceIoUser(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for instance_io_user, skipping detailed parse tests.")

}

func TestSerialize_InstanceIoUser(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "instance_io_user.ksy")
	ksySchema := loadKsySchemaForInstanceIoUser(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for instance_io_user, skipping detailed serialize tests.")
