...
import (
	...
	// The alias helps avoid name collisions if bits_signed_res_b32_be is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForBitsSignedResB32Be(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForBitsSignedResB32Be(t *testing.T, data any) map[string]any {
...
func TestParse_BitsSignedResB32Be(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "bits_signed_res_b32_be.ksy")
	ksySchema := loadKsySchemaForBitsSignedResB32Be(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for bits_signed_res_b32_be, skipping detailed parse tests.")

}

func TestSerialize_BitsSignedResB32Be(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "bits_signed_res_b32_be.ksy")
	ksySchema := loadKsySchemaForBitsSignedResB32Be(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for bits_signed_res_b32_be, skipping detailed serialize tests.")
