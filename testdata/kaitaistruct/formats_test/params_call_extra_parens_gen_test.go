...
import (
	...
	// The alias helps avoid name collisions if params_call_extra_parens is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForParamsCallExtraParens(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForParamsCallExtraParens(t *testing.T, data any) map[string]any {
...
func TestParse_ParamsCallExtraParens(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_call_extra_parens.ksy")
	ksySchema := loadKsySchemaForParamsCallExtraParens(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for params_call_extra_parens, skipping detailed parse tests.")

}

func TestSerialize_ParamsCallExtraParens(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_call_extra_parens.ksy")
	ksySchema := loadKsySchemaForParamsCallExtraParens(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for params_call_extra_parens, skipping detailed serialize tests.")
