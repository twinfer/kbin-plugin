...
import (
	...
	// The alias helps avoid name collisions if switch_manual_int_size_eos is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForSwitchManualIntSizeEos(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForSwitchManualIntSizeEos(t *testing.T, data any) map[string]any {
...
func TestParse_SwitchManualIntSizeEos(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_manual_int_size_eos.ksy")
	ksySchema := loadKsySchemaForSwitchManualIntSizeEos(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for switch_manual_int_size_eos, skipping detailed parse tests.")

}

func TestSerialize_SwitchManualIntSizeEos(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_manual_int_size_eos.ksy")
	ksySchema := loadKsySchemaForSwitchManualIntSizeEos(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for switch_manual_int_size_eos, skipping detailed serialize tests.")
