...
import (
	...
	// The alias helps avoid name collisions if params_enum is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForParamsEnum(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForParamsEnum(t *testing.T, data any) map[string]any {
...
func TestParse_ParamsEnum(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_enum.ksy")
	ksySchema := loadKsySchemaForParamsEnum(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for params_enum, skipping detailed parse tests.")

}

func TestSerialize_ParamsEnum(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_enum.ksy")
	ksySchema := loadKsySchemaForParamsEnum(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for params_enum, skipping detailed serialize tests.")
