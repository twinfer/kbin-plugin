...
import (
	...
	// The alias helps avoid name collisions if type_ternary_2nd_falsy is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForTypeTernary2ndFalsy(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForTypeTernary2ndFalsy(t *testing.T, data any) map[string]any {
...
func TestParse_TypeTernary2ndFalsy(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "type_ternary_2nd_falsy.ksy")
	ksySchema := loadKsySchemaForTypeTernary2ndFalsy(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for type_ternary_2nd_falsy, skipping detailed parse tests.")

}

func TestSerialize_TypeTernary2ndFalsy(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "type_ternary_2nd_falsy.ksy")
	ksySchema := loadKsySchemaForTypeTernary2ndFalsy(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for type_ternary_2nd_falsy, skipping detailed serialize tests.")
