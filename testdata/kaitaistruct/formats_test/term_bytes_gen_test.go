...
import (
	...
	// The alias helps avoid name collisions if term_bytes is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForTermBytes(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForTermBytes(t *testing.T, data any) map[string]any {
...
func TestParse_TermBytes(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "term_bytes.ksy")
	ksySchema := loadKsySchemaForTermBytes(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for term_bytes, skipping detailed parse tests.")

}

func TestSerialize_TermBytes(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "term_bytes.ksy")
	ksySchema := loadKsySchemaForTermBytes(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for term_bytes, skipping detailed serialize tests.")
