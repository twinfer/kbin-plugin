...
import (
	...
	// The alias helps avoid name collisions if params_def_usertype_imported is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForParamsDefUsertypeImported(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForParamsDefUsertypeImported(t *testing.T, data any) map[string]any {
...
func TestParse_ParamsDefUsertypeImported(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_def_usertype_imported.ksy")
	ksySchema := loadKsySchemaForParamsDefUsertypeImported(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for params_def_usertype_imported, skipping detailed parse tests.")

}

func TestSerialize_ParamsDefUsertypeImported(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_def_usertype_imported.ksy")
	ksySchema := loadKsySchemaForParamsDefUsertypeImported(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for params_def_usertype_imported, skipping detailed serialize tests.")
