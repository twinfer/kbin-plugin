...
import (
	...
	// The alias helps avoid name collisions if expr_if_int_ops is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForExprIfIntOps(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForExprIfIntOps(t *testing.T, data any) map[string]any {
...
func TestParse_ExprIfIntOps(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_if_int_ops.ksy")
	ksySchema := loadKsySchemaForExprIfIntOps(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for expr_if_int_ops, skipping detailed parse tests.")

}

func TestSerialize_ExprIfIntOps(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_if_int_ops.ksy")
	ksySchema := loadKsySchemaForExprIfIntOps(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for expr_if_int_ops, skipping detailed serialize tests.")
