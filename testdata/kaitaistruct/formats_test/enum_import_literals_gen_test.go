...
import (
	...
	// The alias helps avoid name collisions if enum_import_literals is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEnumImportLiterals(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEnumImportLiterals(t *testing.T, data any) map[string]any {
...
func TestParse_EnumImportLiterals(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_import_literals.ksy")
	ksySchema := loadKsySchemaForEnumImportLiterals(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for enum_import_literals, skipping detailed parse tests.")

}

func TestSerialize_EnumImportLiterals(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_import_literals.ksy")
	ksySchema := loadKsySchemaForEnumImportLiterals(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for enum_import_literals, skipping detailed serialize tests.")
