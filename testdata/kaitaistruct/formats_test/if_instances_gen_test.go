...
import (
	...
	// The alias helps avoid name collisions if if_instances is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForIfInstances(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForIfInstances(t *testing.T, data any) map[string]any {
...
func TestParse_IfInstances(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "if_instances.ksy")
	ksySchema := loadKsySchemaForIfInstances(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for if_instances, skipping detailed parse tests.")

}

func TestSerialize_IfInstances(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "if_instances.ksy")
	ksySchema := loadKsySchemaForIfInstances(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for if_instances, skipping detailed serialize tests.")
