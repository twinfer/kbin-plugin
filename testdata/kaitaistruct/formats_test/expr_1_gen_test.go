...
import (
	...
	// The alias helps avoid name collisions if expr_1 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForExpr1(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForExpr1(t *testing.T, data any) map[string]any {
...
func TestParse_Expr1(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_1.ksy")
	ksySchema := loadKsySchemaForExpr1(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for expr_1, skipping detailed parse tests.")
...
func TestSerialize_Expr1(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for expr_1, skipping detailed serialize tests.")
