...
import (
	...
	// The alias helps avoid name collisions if index_to_param_until is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForIndexToParamUntil(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForIndexToParamUntil(t *testing.T, data any) map[string]any {
...
func TestParse_IndexToParamUntil(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "index_to_param_until.ksy")
	ksySchema := loadKsySchemaForIndexToParamUntil(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for index_to_param_until, skipping detailed parse tests.")

}

func TestSerialize_IndexToParamUntil(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "index_to_param_until.ksy")
	ksySchema := loadKsySchemaForIndexToParamUntil(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for index_to_param_until, skipping detailed serialize tests.")
