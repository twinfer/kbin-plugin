...
import (
	...
	// The alias helps avoid name collisions if imports_rel_1 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForImportsRel1(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForImportsRel1(t *testing.T, data any) map[string]any {
...
func TestParse_ImportsRel1(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "imports_rel_1.ksy")
	ksySchema := loadKsySchemaForImportsRel1(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for imports_rel_1, skipping detailed parse tests.")

}

func TestSerialize_ImportsRel1(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "imports_rel_1.ksy")
	ksySchema := loadKsySchemaForImportsRel1(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for imports_rel_1, skipping detailed serialize tests.")
