...
import (
	...
	// The alias helps avoid name collisions if bits_signed_res_b32_le is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForBitsSignedResB32Le(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForBitsSignedResB32Le(t *testing.T, data any) map[string]any {
...
func TestParse_BitsSignedResB32Le(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "bits_signed_res_b32_le.ksy")
	ksySchema := loadKsySchemaForBitsSignedResB32Le(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for bits_signed_res_b32_le, skipping detailed parse tests.")

}

func TestSerialize_BitsSignedResB32Le(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "bits_signed_res_b32_le.ksy")
	ksySchema := loadKsySchemaForBitsSignedResB32Le(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for bits_signed_res_b32_le, skipping detailed serialize tests.")
