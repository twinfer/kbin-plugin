...
import (
	...
	// The alias helps avoid name collisions if params_def_array_usertype_imported is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForParamsDefArrayUsertypeImported(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForParamsDefArrayUsertypeImported(t *testing.T, data any) map[string]any {
...
func TestParse_ParamsDefArrayUsertypeImported(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_def_array_usertype_imported.ksy")
	ksySchema := loadKsySchemaForParamsDefArrayUsertypeImported(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for params_def_array_usertype_imported, skipping detailed parse tests.")

}

func TestSerialize_ParamsDefArrayUsertypeImported(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_def_array_usertype_imported.ksy")
	ksySchema := loadKsySchemaForParamsDefArrayUsertypeImported(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for params_def_array_usertype_imported, skipping detailed serialize tests.")
