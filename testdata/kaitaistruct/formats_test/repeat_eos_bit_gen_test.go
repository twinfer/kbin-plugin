...
import (
	...
	// The alias helps avoid name collisions if repeat_eos_bit is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForRepeatEosBit(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForRepeatEosBit(t *testing.T, data any) map[string]any {
...
func TestParse_RepeatEosBit(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "repeat_eos_bit.ksy")
	ksySchema := loadKsySchemaForRepeatEosBit(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for repeat_eos_bit, skipping detailed parse tests.")

}

func TestSerialize_RepeatEosBit(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "repeat_eos_bit.ksy")
	ksySchema := loadKsySchemaForRepeatEosBit(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for repeat_eos_bit, skipping detailed serialize tests.")
