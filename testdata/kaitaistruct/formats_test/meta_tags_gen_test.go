...
import (
	...
	// The alias helps avoid name collisions if meta_tags is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForMetaTags(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForMetaTags(t *testing.T, data any) map[string]any {
...
func TestParse_MetaTags(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "meta_tags.ksy")
	ksySchema := loadKsySchemaForMetaTags(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for meta_tags, skipping detailed parse tests.")

}

func TestSerialize_MetaTags(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "meta_tags.ksy")
	ksySchema := loadKsySchemaForMetaTags(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for meta_tags, skipping detailed serialize tests.")
