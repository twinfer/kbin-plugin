...
import (
	...
	// The alias helps avoid name collisions if switch_manual_enum_invalid is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForSwitchManualEnumInvalid(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForSwitchManualEnumInvalid(t *testing.T, data any) map[string]any {
...
func TestParse_SwitchManualEnumInvalid(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_manual_enum_invalid.ksy")
	ksySchema := loadKsySchemaForSwitchManualEnumInvalid(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for switch_manual_enum_invalid, skipping detailed parse tests.")

}

func TestSerialize_SwitchManualEnumInvalid(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_manual_enum_invalid.ksy")
	ksySchema := loadKsySchemaForSwitchManualEnumInvalid(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for switch_manual_enum_invalid, skipping detailed serialize tests.")
