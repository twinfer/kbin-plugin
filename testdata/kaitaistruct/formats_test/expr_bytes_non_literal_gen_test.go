...
import (
	...
	// The alias helps avoid name collisions if expr_bytes_non_literal is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForExprBytesNonLiteral(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForExprBytesNonLiteral(t *testing.T, data any) map[string]any {
...
func TestParse_ExprBytesNonLiteral(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_bytes_non_literal.ksy")
	ksySchema := loadKsySchemaForExprBytesNonLiteral(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for expr_bytes_non_literal, skipping detailed parse tests.")

}

func TestSerialize_ExprBytesNonLiteral(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_bytes_non_literal.ksy")
	ksySchema := loadKsySchemaForExprBytesNonLiteral(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for expr_bytes_non_literal, skipping detailed serialize tests.")
