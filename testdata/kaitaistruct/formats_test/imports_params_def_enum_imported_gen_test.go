...
import (
	...
	// The alias helps avoid name collisions if imports_params_def_enum_imported is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForImportsParamsDefEnumImported(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForImportsParamsDefEnumImported(t *testing.T, data any) map[string]any {
...
func TestParse_ImportsParamsDefEnumImported(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "imports_params_def_enum_imported.ksy")
	ksySchema := loadKsySchemaForImportsParamsDefEnumImported(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for imports_params_def_enum_imported, skipping detailed parse tests.")
...
func TestSerialize_ImportsParamsDefEnumImported(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for imports_params_def_enum_imported, skipping detailed serialize tests.")
