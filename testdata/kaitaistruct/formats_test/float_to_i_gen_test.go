...
import (
	...
	// The alias helps avoid name collisions if float_to_i is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForFloatToI(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForFloatToI(t *testing.T, data any) map[string]any {
...
func TestParse_FloatToI(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "float_to_i.ksy")
	ksySchema := loadKsySchemaForFloatToI(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for float_to_i, skipping detailed parse tests.")

}

func TestSerialize_FloatToI(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "float_to_i.ksy")
	ksySchema := loadKsySchemaForFloatToI(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for float_to_i, skipping detailed serialize tests.")
