...
import (
	...
	// The alias helps avoid name collisions if process_repeat_bytes is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForProcessRepeatBytes(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForProcessRepeatBytes(t *testing.T, data any) map[string]any {
...
func TestParse_ProcessRepeatBytes(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_repeat_bytes.ksy")
	ksySchema := loadKsySchemaForProcessRepeatBytes(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for process_repeat_bytes, skipping detailed parse tests.")

}

func TestSerialize_ProcessRepeatBytes(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_repeat_bytes.ksy")
	ksySchema := loadKsySchemaForProcessRepeatBytes(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for process_repeat_bytes, skipping detailed serialize tests.")
