...
import (
	...
	// The alias helps avoid name collisions if process_xor4_value is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForProcessXor4Value(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForProcessXor4Value(t *testing.T, data any) map[string]any {
...
func TestParse_ProcessXor4Value(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_xor4_value.ksy")
	ksySchema := loadKsySchemaForProcessXor4Value(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for process_xor4_value, skipping detailed parse tests.")
...
func TestSerialize_ProcessXor4Value(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for process_xor4_value, skipping detailed serialize tests.")
