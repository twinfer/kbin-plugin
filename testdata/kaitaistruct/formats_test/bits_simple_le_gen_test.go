...
import (
	...
	// The alias helps avoid name collisions if bits_simple_le is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForBitsSimpleLe(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForBitsSimpleLe(t *testing.T, data any) map[string]any {
...
func TestParse_BitsSimpleLe(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "bits_simple_le.ksy")
	ksySchema := loadKsySchemaForBitsSimpleLe(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for bits_simple_le, skipping detailed parse tests.")

}

func TestSerialize_BitsSimpleLe(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "bits_simple_le.ksy")
	ksySchema := loadKsySchemaForBitsSimpleLe(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for bits_simple_le, skipping detailed serialize tests.")
