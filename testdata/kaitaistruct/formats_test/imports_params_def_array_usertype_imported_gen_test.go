...
import (
	...
	// The alias helps avoid name collisions if imports_params_def_array_usertype_imported is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForImportsParamsDefArrayUsertypeImported(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForImportsParamsDefArrayUsertypeImported(t *testing.T, data any) map[string]any {
...
func TestParse_ImportsParamsDefArrayUsertypeImported(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "imports_params_def_array_usertype_imported.ksy")
	ksySchema := loadKsySchemaForImportsParamsDefArrayUsertypeImported(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for imports_params_def_array_usertype_imported, skipping detailed parse tests.")

}

func TestSerialize_ImportsParamsDefArrayUsertypeImported(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "imports_params_def_array_usertype_imported.ksy")
	ksySchema := loadKsySchemaForImportsParamsDefArrayUsertypeImported(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for imports_params_def_array_usertype_imported, skipping detailed serialize tests.")
