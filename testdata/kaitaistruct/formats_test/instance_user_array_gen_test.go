...
import (
	...
	// The alias helps avoid name collisions if instance_user_array is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForInstanceUserArray(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForInstanceUserArray(t *testing.T, data any) map[string]any {
...
func TestParse_InstanceUserArray(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "instance_user_array.ksy")
	ksySchema := loadKsySchemaForInstanceUserArray(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for instance_user_array, skipping detailed parse tests.")

}

func TestSerialize_InstanceUserArray(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "instance_user_array.ksy")
	ksySchema := loadKsySchemaForInstanceUserArray(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for instance_user_array, skipping detailed serialize tests.")
