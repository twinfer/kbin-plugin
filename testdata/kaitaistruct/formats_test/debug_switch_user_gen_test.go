...
import (
	...
	// The alias helps avoid name collisions if debug_switch_user is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForDebugSwitchUser(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForDebugSwitchUser(t *testing.T, data any) map[string]any {
...
func TestParse_DebugSwitchUser(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "debug_switch_user.ksy")
	ksySchema := loadKsySchemaForDebugSwitchUser(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for debug_switch_user, skipping detailed parse tests.")

}

func TestSerialize_DebugSwitchUser(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "debug_switch_user.ksy")
	ksySchema := loadKsySchemaForDebugSwitchUser(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for debug_switch_user, skipping detailed serialize tests.")
