...
import (
	...
	// The alias helps avoid name collisions if nav_parent_override is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForNavParentOverride(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForNavParentOverride(t *testing.T, data any) map[string]any {
...
func TestParse_NavParentOverride(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nav_parent_override.ksy")
	ksySchema := loadKsySchemaForNavParentOverride(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for nav_parent_override, skipping detailed parse tests.")

}

func TestSerialize_NavParentOverride(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nav_parent_override.ksy")
	ksySchema := loadKsySchemaForNavParentOverride(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for nav_parent_override, skipping detailed serialize tests.")
