...
import (
	...
	// The alias helps avoid name collisions if process_xor_value is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForProcessXorValue(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForProcessXorValue(t *testing.T, data any) map[string]any {
...
func TestParse_ProcessXorValue(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_xor_value.ksy")
	ksySchema := loadKsySchemaForProcessXorValue(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for process_xor_value, skipping detailed parse tests.")

}

func TestSerialize_ProcessXorValue(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_xor_value.ksy")
	ksySchema := loadKsySchemaForProcessXorValue(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for process_xor_value, skipping detailed serialize tests.")
