...
import (
	...
	// The alias helps avoid name collisions if process_repeat_usertype is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForProcessRepeatUsertype(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForProcessRepeatUsertype(t *testing.T, data any) map[string]any {
...
func TestParse_ProcessRepeatUsertype(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_repeat_usertype.ksy")
	ksySchema := loadKsySchemaForProcessRepeatUsertype(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for process_repeat_usertype, skipping detailed parse tests.")

}

func TestSerialize_ProcessRepeatUsertype(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_repeat_usertype.ksy")
	ksySchema := loadKsySchemaForProcessRepeatUsertype(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for process_repeat_usertype, skipping detailed serialize tests.")
