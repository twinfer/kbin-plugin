...
import (
	...
	// The alias helps avoid name collisions if expr_bytes_ops is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForExprBytesOps(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForExprBytesOps(t *testing.T, data any) map[string]any {
...
func TestParse_ExprBytesOps(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_bytes_ops.ksy")
	ksySchema := loadKsySchemaForExprBytesOps(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for expr_bytes_ops, skipping detailed parse tests.")

}

func TestSerialize_ExprBytesOps(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_bytes_ops.ksy")
	ksySchema := loadKsySchemaForExprBytesOps(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for expr_bytes_ops, skipping detailed serialize tests.")
