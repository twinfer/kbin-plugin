...
import (
	...
	// The alias helps avoid name collisions if switch_manual_int_size is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForSwitchManualIntSize(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForSwitchManualIntSize(t *testing.T, data any) map[string]any {
...
func TestParse_SwitchManualIntSize(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_manual_int_size.ksy")
	ksySchema := loadKsySchemaForSwitchManualIntSize(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for switch_manual_int_size, skipping detailed parse tests.")

}

func TestSerialize_SwitchManualIntSize(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_manual_int_size.ksy")
	ksySchema := loadKsySchemaForSwitchManualIntSize(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for switch_manual_int_size, skipping detailed serialize tests.")
