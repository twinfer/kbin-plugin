...
import (
	...
	// The alias helps avoid name collisions if enum_deep is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEnumDeep(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEnumDeep(t *testing.T, data any) map[string]any {
...
func TestParse_EnumDeep(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_deep.ksy")
	ksySchema := loadKsySchemaForEnumDeep(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for enum_deep, skipping detailed parse tests.")

}

func TestSerialize_EnumDeep(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_deep.ksy")
	ksySchema := loadKsySchemaForEnumDeep(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for enum_deep, skipping detailed serialize tests.")
