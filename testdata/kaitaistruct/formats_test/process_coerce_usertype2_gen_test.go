...
import (
	...
	// The alias helps avoid name collisions if process_coerce_usertype2 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForProcessCoerceUsertype2(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForProcessCoerceUsertype2(t *testing.T, data any) map[string]any {
...
func TestParse_ProcessCoerceUsertype2(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_coerce_usertype2.ksy")
	ksySchema := loadKsySchemaForProcessCoerceUsertype2(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for process_coerce_usertype2, skipping detailed parse tests.")

}

func TestSerialize_ProcessCoerceUsertype2(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_coerce_usertype2.ksy")
	ksySchema := loadKsySchemaForProcessCoerceUsertype2(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for process_coerce_usertype2, skipping detailed serialize tests.")
