...
import (
	...
	// The alias helps avoid name collisions if combine_enum is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForCombineEnum(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForCombineEnum(t *testing.T, data any) map[string]any {
...
func TestParse_CombineEnum(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "combine_enum.ksy")
	ksySchema := loadKsySchemaForCombineEnum(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for combine_enum, skipping detailed parse tests.")

}

func TestSerialize_CombineEnum(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "combine_enum.ksy")
	ksySchema := loadKsySchemaForCombineEnum(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for combine_enum, skipping detailed serialize tests.")
