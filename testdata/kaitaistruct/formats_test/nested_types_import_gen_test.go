...
import (
	...
	// The alias helps avoid name collisions if nested_types_import is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForNestedTypesImport(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForNestedTypesImport(t *testing.T, data any) map[string]any {
...
func TestParse_NestedTypesImport(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nested_types_import.ksy")
	ksySchema := loadKsySchemaForNestedTypesImport(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for nested_types_import, skipping detailed parse tests.")

}

func TestSerialize_NestedTypesImport(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nested_types_import.ksy")
	ksySchema := loadKsySchemaForNestedTypesImport(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for nested_types_import, skipping detailed serialize tests.")
