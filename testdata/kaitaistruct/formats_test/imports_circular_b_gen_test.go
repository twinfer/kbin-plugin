...
import (
	...
	// The alias helps avoid name collisions if imports_circular_b is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForImportsCircularB(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForImportsCircularB(t *testing.T, data any) map[string]any {
...
func TestParse_ImportsCircularB(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "imports_circular_b.ksy")
	ksySchema := loadKsySchemaForImportsCircularB(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for imports_circular_b, skipping detailed parse tests.")

}

func TestSerialize_ImportsCircularB(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "imports_circular_b.ksy")
	ksySchema := loadKsySchemaForImportsCircularB(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for imports_circular_b, skipping detailed serialize tests.")
