...
import (
	...
	// The alias helps avoid name collisions if expr_enum is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForExprEnum(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForExprEnum(t *testing.T, data any) map[string]any {
...
func TestParse_ExprEnum(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_enum.ksy")
	ksySchema := loadKsySchemaForExprEnum(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for expr_enum, skipping detailed parse tests.")

}

func TestSerialize_ExprEnum(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_enum.ksy")
	ksySchema := loadKsySchemaForExprEnum(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for expr_enum, skipping detailed serialize tests.")
