...
import (
	...
	// The alias helps avoid name collisions if nav_parent_vs_value_inst is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForNavParentVsValueInst(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForNavParentVsValueInst(t *testing.T, data any) map[string]any {
...
func TestParse_NavParentVsValueInst(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nav_parent_vs_value_inst.ksy")
	ksySchema := loadKsySchemaForNavParentVsValueInst(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for nav_parent_vs_value_inst, skipping detailed parse tests.")

}

func TestSerialize_NavParentVsValueInst(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nav_parent_vs_value_inst.ksy")
	ksySchema := loadKsySchemaForNavParentVsValueInst(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for nav_parent_vs_value_inst, skipping detailed serialize tests.")
