...
import (
	...
	// The alias helps avoid name collisions if nav_root is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForNavRoot(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForNavRoot(t *testing.T, data any) map[string]any {
...
func TestParse_NavRoot(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nav_root.ksy")
	ksySchema := loadKsySchemaForNavRoot(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for nav_root, skipping detailed parse tests.")

}

func TestSerialize_NavRoot(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nav_root.ksy")
	ksySchema := loadKsySchemaForNavRoot(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for nav_root, skipping detailed serialize tests.")
