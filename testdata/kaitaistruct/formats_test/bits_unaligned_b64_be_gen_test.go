...
import (
	...
	// The alias helps avoid name collisions if bits_unaligned_b64_be is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForBitsUnalignedB64Be(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForBitsUnalignedB64Be(t *testing.T, data any) map[string]any {
...
func TestParse_BitsUnalignedB64Be(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "bits_unaligned_b64_be.ksy")
	ksySchema := loadKsySchemaForBitsUnalignedB64Be(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for bits_unaligned_b64_be, skipping detailed parse tests.")

}

func TestSerialize_BitsUnalignedB64Be(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "bits_unaligned_b64_be.ksy")
	ksySchema := loadKsySchemaForBitsUnalignedB64Be(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for bits_unaligned_b64_be, skipping detailed serialize tests.")
