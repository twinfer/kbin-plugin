...
import (
	...
	// The alias helps avoid name collisions if expr_sizeof_type_1 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForExprSizeofType1(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForExprSizeofType1(t *testing.T, data any) map[string]any {
...
func TestParse_ExprSizeofType1(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_sizeof_type_1.ksy")
	ksySchema := loadKsySchemaForExprSizeofType1(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for expr_sizeof_type_1, skipping detailed parse tests.")

}

func TestSerialize_ExprSizeofType1(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_sizeof_type_1.ksy")
	ksySchema := loadKsySchemaForExprSizeofType1(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for expr_sizeof_type_1, skipping detailed serialize tests.")
