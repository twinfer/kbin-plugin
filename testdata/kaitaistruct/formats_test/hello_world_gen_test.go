...
import (
	...
	// The alias helps avoid name collisions if hello_world is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForHelloWorld(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForHelloWorld(t *testing.T, data any) map[string]any {
...
func TestParse_HelloWorld(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "hello_world.ksy")
	ksySchema := loadKsySchemaForHelloWorld(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for hello_world, skipping detailed parse tests.")

}

func TestSerialize_HelloWorld(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "hello_world.ksy")
	ksySchema := loadKsySchemaForHelloWorld(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for hello_world, skipping detailed serialize tests.")
