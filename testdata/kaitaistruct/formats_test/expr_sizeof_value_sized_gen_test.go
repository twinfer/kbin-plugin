...
import (
	...
	// The alias helps avoid name collisions if expr_sizeof_value_sized is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForExprSizeofValueSized(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForExprSizeofValueSized(t *testing.T, data any) map[string]any {
...
func TestParse_ExprSizeofValueSized(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_sizeof_value_sized.ksy")
	ksySchema := loadKsySchemaForExprSizeofValueSized(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for expr_sizeof_value_sized, skipping detailed parse tests.")
...
func TestSerialize_ExprSizeofValueSized(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for expr_sizeof_value_sized, skipping detailed serialize tests.")
