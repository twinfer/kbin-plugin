...
import (
	...
	// The alias helps avoid name collisions if combine_bool is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForCombineBool(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForCombineBool(t *testing.T, data any) map[string]any {
...
func TestParse_CombineBool(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "combine_bool.ksy")
	ksySchema := loadKsySchemaForCombineBool(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for combine_bool, skipping detailed parse tests.")

}

func TestSerialize_CombineBool(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "combine_bool.ksy")
	ksySchema := loadKsySchemaForCombineBool(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for combine_bool, skipping detailed serialize tests.")
