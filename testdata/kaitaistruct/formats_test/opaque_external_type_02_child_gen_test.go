...
import (
	...
	// The alias helps avoid name collisions if opaque_external_type_02_child is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForOpaqueExternalType02Child(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForOpaqueExternalType02Child(t *testing.T, data any) map[string]any {
...
func TestParse_OpaqueExternalType02Child(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "opaque_external_type_02_child.ksy")
	ksySchema := loadKsySchemaForOpaqueExternalType02Child(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for opaque_external_type_02_child, skipping detailed parse tests.")

}

func TestSerialize_OpaqueExternalType02Child(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "opaque_external_type_02_child.ksy")
	ksySchema := loadKsySchemaForOpaqueExternalType02Child(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for opaque_external_type_02_child, skipping detailed serialize tests.")
