...
import (
	...
	// The alias helps avoid name collisions if bytes_pad_term is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForBytesPadTerm(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForBytesPadTerm(t *testing.T, data any) map[string]any {
...
func TestParse_BytesPadTerm(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "bytes_pad_term.ksy")
	ksySchema := loadKsySchemaForBytesPadTerm(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for bytes_pad_term, skipping detailed parse tests.")

}

func TestSerialize_BytesPadTerm(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "bytes_pad_term.ksy")
	ksySchema := loadKsySchemaForBytesPadTerm(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for bytes_pad_term, skipping detailed serialize tests.")
