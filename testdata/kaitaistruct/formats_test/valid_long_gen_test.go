...
import (
	...
	// The alias helps avoid name collisions if valid_long is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForValidLong(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForValidLong(t *testing.T, data any) map[string]any {
...
func TestParse_ValidLong(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "valid_long.ksy")
	ksySchema := loadKsySchemaForValidLong(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for valid_long, skipping detailed parse tests.")

}

func TestSerialize_ValidLong(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "valid_long.ksy")
	ksySchema := loadKsySchemaForValidLong(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for valid_long, skipping detailed serialize tests.")
