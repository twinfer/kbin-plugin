...
import (
	...
	// The alias helps avoid name collisions if default_big_endian is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForDefaultBigEndian(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForDefaultBigEndian(t *testing.T, data any) map[string]any {
...
func TestParse_DefaultBigEndian(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "default_big_endian.ksy")
	ksySchema := loadKsySchemaForDefaultBigEndian(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for default_big_endian, skipping detailed parse tests.")

}

func TestSerialize_DefaultBigEndian(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "default_big_endian.ksy")
	ksySchema := loadKsySchemaForDefaultBigEndian(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for default_big_endian, skipping detailed serialize tests.")
