...
import (
	...
	// The alias helps avoid name collisions if opaque_with_param is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForOpaqueWithParam(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForOpaqueWithParam(t *testing.T, data any) map[string]any {
...
func TestParse_OpaqueWithParam(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "opaque_with_param.ksy")
	ksySchema := loadKsySchemaForOpaqueWithParam(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for opaque_with_param, skipping detailed parse tests.")
...
func TestSerialize_OpaqueWithParam(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for opaque_with_param, skipping detailed serialize tests.")
