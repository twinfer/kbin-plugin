...
import (
	...
	// The alias helps avoid name collisions if params_pass_array_int is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForParamsPassArrayInt(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForParamsPassArrayInt(t *testing.T, data any) map[string]any {
...
func TestParse_ParamsPassArrayInt(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_pass_array_int.ksy")
	ksySchema := loadKsySchemaForParamsPassArrayInt(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for params_pass_array_int, skipping detailed parse tests.")

}

func TestSerialize_ParamsPassArrayInt(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_pass_array_int.ksy")
	ksySchema := loadKsySchemaForParamsPassArrayInt(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for params_pass_array_int, skipping detailed serialize tests.")
