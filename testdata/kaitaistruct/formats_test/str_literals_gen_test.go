...
import (
	...
	// The alias helps avoid name collisions if str_literals is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForStrLiterals(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForStrLiterals(t *testing.T, data any) map[string]any {
...
func TestParse_StrLiterals(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "str_literals.ksy")
	ksySchema := loadKsySchemaForStrLiterals(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for str_literals, skipping detailed parse tests.")

}

func TestSerialize_StrLiterals(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "str_literals.ksy")
	ksySchema := loadKsySchemaForStrLiterals(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for str_literals, skipping detailed serialize tests.")
