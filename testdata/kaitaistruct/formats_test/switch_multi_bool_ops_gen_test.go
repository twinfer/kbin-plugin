...
import (
	...
	// The alias helps avoid name collisions if switch_multi_bool_ops is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForSwitchMultiBoolOps(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForSwitchMultiBoolOps(t *testing.T, data any) map[string]any {
...
func TestParse_SwitchMultiBoolOps(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_multi_bool_ops.ksy")
	ksySchema := loadKsySchemaForSwitchMultiBoolOps(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for switch_multi_bool_ops, skipping detailed parse tests.")

}

func TestSerialize_SwitchMultiBoolOps(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_multi_bool_ops.ksy")
	ksySchema := loadKsySchemaForSwitchMultiBoolOps(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for switch_multi_bool_ops, skipping detailed serialize tests.")
