...
import (
	...
	// The alias helps avoid name collisions if params_pass_struct is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForParamsPassStruct(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForParamsPassStruct(t *testing.T, data any) map[string]any {
...
func TestParse_ParamsPassStruct(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_pass_struct.ksy")
	ksySchema := loadKsySchemaForParamsPassStruct(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for params_pass_struct, skipping detailed parse tests.")

}

func TestSerialize_ParamsPassStruct(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_pass_struct.ksy")
	ksySchema := loadKsySchemaForParamsPassStruct(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for params_pass_struct, skipping detailed serialize tests.")
