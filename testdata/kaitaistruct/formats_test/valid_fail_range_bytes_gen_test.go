...
import (
	...
	// The alias helps avoid name collisions if valid_fail_range_bytes is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForValidFailRangeBytes(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForValidFailRangeBytes(t *testing.T, data any) map[string]any {
...
func TestParse_ValidFailRangeBytes(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "valid_fail_range_bytes.ksy")
	ksySchema := loadKsySchemaForValidFailRangeBytes(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for valid_fail_range_bytes, skipping detailed parse tests.")

}

func TestSerialize_ValidFailRangeBytes(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "valid_fail_range_bytes.ksy")
	ksySchema := loadKsySchemaForValidFailRangeBytes(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for valid_fail_range_bytes, skipping detailed serialize tests.")
