...
import (
	...
	// The alias helps avoid name collisions if params_pass_bool is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForParamsPassBool(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForParamsPassBool(t *testing.T, data any) map[string]any {
...
func TestParse_ParamsPassBool(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_pass_bool.ksy")
	ksySchema := loadKsySchemaForParamsPassBool(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for params_pass_bool, skipping detailed parse tests.")

}

func TestSerialize_ParamsPassBool(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_pass_bool.ksy")
	ksySchema := loadKsySchemaForParamsPassBool(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for params_pass_bool, skipping detailed serialize tests.")
