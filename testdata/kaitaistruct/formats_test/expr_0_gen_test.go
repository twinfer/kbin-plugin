...
import (
	...
	// The alias helps avoid name collisions if expr_0 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForExpr0(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForExpr0(t *testing.T, data any) map[string]any {
...
func TestParse_Expr0(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_0.ksy")
	ksySchema := loadKsySchemaForExpr0(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for expr_0, skipping detailed parse tests.")

}

func TestSerialize_Expr0(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_0.ksy")
	ksySchema := loadKsySchemaForExpr0(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for expr_0, skipping detailed serialize tests.")
