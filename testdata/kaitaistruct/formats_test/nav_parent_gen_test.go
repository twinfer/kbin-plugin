...
import (
	...
	// The alias helps avoid name collisions if nav_parent is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForNavParent(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForNavParent(t *testing.T, data any) map[string]any {
...
func TestParse_NavParent(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nav_parent.ksy")
	ksySchema := loadKsySchemaForNavParent(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for nav_parent, skipping detailed parse tests.")

}

func TestSerialize_NavParent(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nav_parent.ksy")
	ksySchema := loadKsySchemaForNavParent(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for nav_parent, skipping detailed serialize tests.")
