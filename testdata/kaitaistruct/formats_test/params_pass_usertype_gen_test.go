...
import (
	...
	// The alias helps avoid name collisions if params_pass_usertype is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForParamsPassUsertype(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForParamsPassUsertype(t *testing.T, data any) map[string]any {
...
func TestParse_ParamsPassUsertype(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_pass_usertype.ksy")
	ksySchema := loadKsySchemaForParamsPassUsertype(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for params_pass_usertype, skipping detailed parse tests.")

}

func TestSerialize_ParamsPassUsertype(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_pass_usertype.ksy")
	ksySchema := loadKsySchemaForParamsPassUsertype(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for params_pass_usertype, skipping detailed serialize tests.")
