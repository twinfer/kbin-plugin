...
import (
	...
	// The alias helps avoid name collisions if debug_array_user is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForDebugArrayUser(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForDebugArrayUser(t *testing.T, data any) map[string]any {
...
func TestParse_DebugArrayUser(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "debug_array_user.ksy")
	ksySchema := loadKsySchemaForDebugArrayUser(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for debug_array_user, skipping detailed parse tests.")

}

func TestSerialize_DebugArrayUser(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "debug_array_user.ksy")
	ksySchema := loadKsySchemaForDebugArrayUser(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for debug_array_user, skipping detailed serialize tests.")
