...
import (
	...
	// The alias helps avoid name collisions if nav_parent_false2 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForNavParentFalse2(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForNavParentFalse2(t *testing.T, data any) map[string]any {
...
func TestParse_NavParentFalse2(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nav_parent_false2.ksy")
	ksySchema := loadKsySchemaForNavParentFalse2(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for nav_parent_false2, skipping detailed parse tests.")

}

func TestSerialize_NavParentFalse2(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nav_parent_false2.ksy")
	ksySchema := loadKsySchemaForNavParentFalse2(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for nav_parent_false2, skipping detailed serialize tests.")
