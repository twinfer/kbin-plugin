...
import (
	...
	// The alias helps avoid name collisions if params_def is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForParamsDef(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForParamsDef(t *testing.T, data any) map[string]any {
...
func TestParse_ParamsDef(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_def.ksy")
	ksySchema := loadKsySchemaForParamsDef(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for params_def, skipping detailed parse tests.")

}

func TestSerialize_ParamsDef(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_def.ksy")
	ksySchema := loadKsySchemaForParamsDef(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for params_def, skipping detailed serialize tests.")
