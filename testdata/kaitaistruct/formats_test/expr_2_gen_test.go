...
import (
	...
	// The alias helps avoid name collisions if expr_2 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForExpr2(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForExpr2(t *testing.T, data any) map[string]any {
...
func TestParse_Expr2(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_2.ksy")
	ksySchema := loadKsySchemaForExpr2(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for expr_2, skipping detailed parse tests.")
...
func TestSerialize_Expr2(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for expr_2, skipping detailed serialize tests.")
