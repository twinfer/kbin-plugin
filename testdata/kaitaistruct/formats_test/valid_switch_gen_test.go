...
import (
	...
	// The alias helps avoid name collisions if valid_switch is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForValidSwitch(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForValidSwitch(t *testing.T, data any) map[string]any {
...
func TestParse_ValidSwitch(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "valid_switch.ksy")
	ksySchema := loadKsySchemaForValidSwitch(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for valid_switch, skipping detailed parse tests.")

}

func TestSerialize_ValidSwitch(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "valid_switch.ksy")
	ksySchema := loadKsySchemaForValidSwitch(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for valid_switch, skipping detailed serialize tests.")
