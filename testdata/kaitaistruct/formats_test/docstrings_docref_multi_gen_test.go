...
import (
	...
	docstrings_docref_multi_kaitai "github.com/twinfer/kbin-plugin/testdata/formats_kaitai_go_gen/docstrings_docref_multi"
)

func TestParse_DocstringsDocrefMulti(t *testing.T) {
	// Load schema
	ksyPath := filepath.Join("../../../test/formats", "docstrings_docref_multi.ksy")
...
func TestSerialize_DocstringsDocrefMulti(t *testing.T) {
	...
	original := docstrings_docref_multi_kaitai.NewDocstringsDocrefMulti()
	err = original.Read(stream, original, original)
	require.NoError(t, err)

	// Serialize and verify round-trip
	inputMap := structToMapDocstringsDocrefMulti(t, original)
	...
	reparsed := docstrings_docref_multi_kaitai.NewDocstringsDocrefMulti()
	...
	cmpOpts := []cmp.Option{
		...
		cmpopts.IgnoreFields(docstrings_docref_multi_kaitai.DocstringsDocrefMulti{}, "_io", "_parent", "_root"),
		cmpopts.EquateEmpty(),
	}
...
// structToMapDocstringsDocrefMulti converts KSC struct to map for serializer
func structToMapDocstringsDocrefMulti(t *testing.T, data any) map[string]any {
	// Use reflection to handle KSC structs with method-based values
	return structToMapReflectiveDocstringsDocrefMulti(t, data)
}

// structToMapReflectiveDocstringsDocrefMulti uses reflection to convert KSC structs including method calls
func structToMapReflectiveDocstringsDocrefMulti(t *testing.T, data any) map[string]any {
	...
	for i := 0; i < val.NumField(); i++ {
		...
		case reflect.Ptr:
			if !fieldVal.IsNil() {
				...
				subMap := structToMapReflectiveDocstringsDocrefMulti(t, fieldVal.Interface())
