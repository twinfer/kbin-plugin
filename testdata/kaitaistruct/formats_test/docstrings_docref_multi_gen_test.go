...
import (
	...
	// The alias helps avoid name collisions if docstrings_docref_multi is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForDocstringsDocrefMulti(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForDocstringsDocrefMulti(t *testing.T, data any) map[string]any {
...
func TestParse_DocstringsDocrefMulti(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "docstrings_docref_multi.ksy")
	ksySchema := loadKsySchemaForDocstringsDocrefMulti(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for docstrings_docref_multi, skipping detailed parse tests.")

}

func TestSerialize_DocstringsDocrefMulti(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "docstrings_docref_multi.ksy")
	ksySchema := loadKsySchemaForDocstringsDocrefMulti(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for docstrings_docref_multi, skipping detailed serialize tests.")
