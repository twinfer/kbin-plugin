...
import (
	...
	// The alias helps avoid name collisions if eof_exception_sized is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEofExceptionSized(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEofExceptionSized(t *testing.T, data any) map[string]any {
...
func TestParse_EofExceptionSized(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "eof_exception_sized.ksy")
	ksySchema := loadKsySchemaForEofExceptionSized(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for eof_exception_sized, skipping detailed parse tests.")

}

func TestSerialize_EofExceptionSized(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "eof_exception_sized.ksy")
	ksySchema := loadKsySchemaForEofExceptionSized(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for eof_exception_sized, skipping detailed serialize tests.")
