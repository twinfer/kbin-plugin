...
import (
	...
	// The alias helps avoid name collisions if debug_array_user_eof_exception is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForDebugArrayUserEofException(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForDebugArrayUserEofException(t *testing.T, data any) map[string]any {
...
func TestParse_DebugArrayUserEofException(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "debug_array_user_eof_exception.ksy")
	ksySchema := loadKsySchemaForDebugArrayUserEofException(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for debug_array_user_eof_exception, skipping detailed parse tests.")

}

func TestSerialize_DebugArrayUserEofException(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "debug_array_user_eof_exception.ksy")
	ksySchema := loadKsySchemaForDebugArrayUserEofException(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for debug_array_user_eof_exception, skipping detailed serialize tests.")
