...
import (
	...
	// The alias helps avoid name collisions if non_standard is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForNonStandard(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForNonStandard(t *testing.T, data any) map[string]any {
...
func TestParse_NonStandard(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "non_standard.ksy")
	ksySchema := loadKsySchemaForNonStandard(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for non_standard, skipping detailed parse tests.")

}

func TestSerialize_NonStandard(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "non_standard.ksy")
	ksySchema := loadKsySchemaForNonStandard(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for non_standard, skipping detailed serialize tests.")
