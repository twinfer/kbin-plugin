...
import (
	...
	// The alias helps avoid name collisions if optional_id is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForOptionalId(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForOptionalId(t *testing.T, data any) map[string]any {
...
func TestParse_OptionalId(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "optional_id.ksy")
	ksySchema := loadKsySchemaForOptionalId(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for optional_id, skipping detailed parse tests.")

}

func TestSerialize_OptionalId(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "optional_id.ksy")
	ksySchema := loadKsySchemaForOptionalId(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for optional_id, skipping detailed serialize tests.")
