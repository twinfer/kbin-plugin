...
import (
	...
	// The alias helps avoid name collisions if process_custom is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForProcessCustom(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForProcessCustom(t *testing.T, data any) map[string]any {
...
func TestParse_ProcessCustom(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_custom.ksy")
	ksySchema := loadKsySchemaForProcessCustom(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for process_custom, skipping detailed parse tests.")

}

func TestSerialize_ProcessCustom(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_custom.ksy")
	ksySchema := loadKsySchemaForProcessCustom(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for process_custom, skipping detailed serialize tests.")
