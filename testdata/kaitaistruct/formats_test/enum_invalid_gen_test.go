...
import (
	...
	// The alias helps avoid name collisions if enum_invalid is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEnumInvalid(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEnumInvalid(t *testing.T, data any) map[string]any {
...
func TestParse_EnumInvalid(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_invalid.ksy")
	ksySchema := loadKsySchemaForEnumInvalid(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for enum_invalid, skipping detailed parse tests.")

}

func TestSerialize_EnumInvalid(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_invalid.ksy")
	ksySchema := loadKsySchemaForEnumInvalid(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for enum_invalid, skipping detailed serialize tests.")
