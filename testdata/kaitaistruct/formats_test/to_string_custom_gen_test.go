...
import (
	...
	// The alias helps avoid name collisions if to_string_custom is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForToStringCustom(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForToStringCustom(t *testing.T, data any) map[string]any {
...
func TestParse_ToStringCustom(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "to_string_custom.ksy")
	ksySchema := loadKsySchemaForToStringCustom(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for to_string_custom, skipping detailed parse tests.")

}

func TestSerialize_ToStringCustom(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "to_string_custom.ksy")
	ksySchema := loadKsySchemaForToStringCustom(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for to_string_custom, skipping detailed serialize tests.")
