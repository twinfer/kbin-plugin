...
import (
	...
	// The alias helps avoid name collisions if js_signed_right_shift is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForJsSignedRightShift(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForJsSignedRightShift(t *testing.T, data any) map[string]any {
...
func TestParse_JsSignedRightShift(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "js_signed_right_shift.ksy")
	ksySchema := loadKsySchemaForJsSignedRightShift(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for js_signed_right_shift, skipping detailed parse tests.")

}

func TestSerialize_JsSignedRightShift(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "js_signed_right_shift.ksy")
	ksySchema := loadKsySchemaForJsSignedRightShift(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for js_signed_right_shift, skipping detailed serialize tests.")
