...
import (
	...
	// The alias helps avoid name collisions if nested_type_param is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForNestedTypeParam(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForNestedTypeParam(t *testing.T, data any) map[string]any {
...
func TestParse_NestedTypeParam(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nested_type_param.ksy")
	ksySchema := loadKsySchemaForNestedTypeParam(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for nested_type_param, skipping detailed parse tests.")

}

func TestSerialize_NestedTypeParam(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nested_type_param.ksy")
	ksySchema := loadKsySchemaForNestedTypeParam(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for nested_type_param, skipping detailed serialize tests.")
