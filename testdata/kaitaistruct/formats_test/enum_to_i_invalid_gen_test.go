...
import (
	...
	// The alias helps avoid name collisions if enum_to_i_invalid is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEnumToIInvalid(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEnumToIInvalid(t *testing.T, data any) map[string]any {
...
func TestParse_EnumToIInvalid(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_to_i_invalid.ksy")
	ksySchema := loadKsySchemaForEnumToIInvalid(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for enum_to_i_invalid, skipping detailed parse tests.")

}

func TestSerialize_EnumToIInvalid(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_to_i_invalid.ksy")
	ksySchema := loadKsySchemaForEnumToIInvalid(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for enum_to_i_invalid, skipping detailed serialize tests.")
