...
import (
	...
	// The alias helps avoid name collisions if default_endian_expr_exception is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForDefaultEndianExprException(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForDefaultEndianExprException(t *testing.T, data any) map[string]any {
...
func TestParse_DefaultEndianExprException(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "default_endian_expr_exception.ksy")
	ksySchema := loadKsySchemaForDefaultEndianExprException(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for default_endian_expr_exception, skipping detailed parse tests.")

}

func TestSerialize_DefaultEndianExprException(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "default_endian_expr_exception.ksy")
	ksySchema := loadKsySchemaForDefaultEndianExprException(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for default_endian_expr_exception, skipping detailed serialize tests.")
