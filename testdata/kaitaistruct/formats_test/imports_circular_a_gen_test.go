...
import (
	...
	// The alias helps avoid name collisions if imports_circular_a is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForImportsCircularA(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForImportsCircularA(t *testing.T, data any) map[string]any {
...
func TestParse_ImportsCircularA(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "imports_circular_a.ksy")
	ksySchema := loadKsySchemaForImportsCircularA(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for imports_circular_a, skipping detailed parse tests.")

}

func TestSerialize_ImportsCircularA(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "imports_circular_a.ksy")
	ksySchema := loadKsySchemaForImportsCircularA(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for imports_circular_a, skipping detailed serialize tests.")
