...
import (
	...
	// The alias helps avoid name collisions if expr_ops_parens is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForExprOpsParens(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForExprOpsParens(t *testing.T, data any) map[string]any {
...
func TestParse_ExprOpsParens(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_ops_parens.ksy")
	ksySchema := loadKsySchemaForExprOpsParens(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for expr_ops_parens, skipping detailed parse tests.")
...
func TestSerialize_ExprOpsParens(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for expr_ops_parens, skipping detailed serialize tests.")
