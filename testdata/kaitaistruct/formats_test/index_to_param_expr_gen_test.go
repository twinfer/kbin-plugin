...
import (
	...
	// The alias helps avoid name collisions if index_to_param_expr is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForIndexToParamExpr(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForIndexToParamExpr(t *testing.T, data any) map[string]any {
...
func TestParse_IndexToParamExpr(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "index_to_param_expr.ksy")
	ksySchema := loadKsySchemaForIndexToParamExpr(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for index_to_param_expr, skipping detailed parse tests.")

}

func TestSerialize_IndexToParamExpr(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "index_to_param_expr.ksy")
	ksySchema := loadKsySchemaForIndexToParamExpr(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for index_to_param_expr, skipping detailed serialize tests.")
