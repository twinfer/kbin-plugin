...
import (
	...
	// The alias helps avoid name collisions if default_endian_expr_is_le is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForDefaultEndianExprIsLe(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForDefaultEndianExprIsLe(t *testing.T, data any) map[string]any {
...
func TestParse_DefaultEndianExprIsLe(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "default_endian_expr_is_le.ksy")
	ksySchema := loadKsySchemaForDefaultEndianExprIsLe(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for default_endian_expr_is_le, skipping detailed parse tests.")

}

func TestSerialize_DefaultEndianExprIsLe(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "default_endian_expr_is_le.ksy")
	ksySchema := loadKsySchemaForDefaultEndianExprIsLe(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for default_endian_expr_is_le, skipping detailed serialize tests.")
