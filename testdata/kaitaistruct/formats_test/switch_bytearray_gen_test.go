...
import (
	...
	// The alias helps avoid name collisions if switch_bytearray is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForSwitchBytearray(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForSwitchBytearray(t *testing.T, data any) map[string]any {
...
func TestParse_SwitchBytearray(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_bytearray.ksy")
	ksySchema := loadKsySchemaForSwitchBytearray(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for switch_bytearray, skipping detailed parse tests.")

}

func TestSerialize_SwitchBytearray(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_bytearray.ksy")
	ksySchema := loadKsySchemaForSwitchBytearray(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for switch_bytearray, skipping detailed serialize tests.")
