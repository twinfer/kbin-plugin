...
import (
	...
	// The alias helps avoid name collisions if switch_manual_enum is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForSwitchManualEnum(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForSwitchManualEnum(t *testing.T, data any) map[string]any {
...
func TestParse_SwitchManualEnum(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_manual_enum.ksy")
	ksySchema := loadKsySchemaForSwitchManualEnum(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for switch_manual_enum, skipping detailed parse tests.")

}

func TestSerialize_SwitchManualEnum(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_manual_enum.ksy")
	ksySchema := loadKsySchemaForSwitchManualEnum(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for switch_manual_enum, skipping detailed serialize tests.")
