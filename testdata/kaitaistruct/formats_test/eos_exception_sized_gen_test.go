...
import (
	...
	// The alias helps avoid name collisions if eos_exception_sized is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEosExceptionSized(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEosExceptionSized(t *testing.T, data any) map[string]any {
...
func TestParse_EosExceptionSized(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "eos_exception_sized.ksy")
	ksySchema := loadKsySchemaForEosExceptionSized(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for eos_exception_sized, skipping detailed parse tests.")

}

func TestSerialize_EosExceptionSized(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "eos_exception_sized.ksy")
	ksySchema := loadKsySchemaForEosExceptionSized(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for eos_exception_sized, skipping detailed serialize tests.")
