...
import (
	...
	// The alias helps avoid name collisions if nav_parent3 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForNavParent3(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForNavParent3(t *testing.T, data any) map[string]any {
...
func TestParse_NavParent3(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nav_parent3.ksy")
	ksySchema := loadKsySchemaForNavParent3(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for nav_parent3, skipping detailed parse tests.")

}

func TestSerialize_NavParent3(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nav_parent3.ksy")
	ksySchema := loadKsySchemaForNavParent3(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for nav_parent3, skipping detailed serialize tests.")
