...
import (
	...
	// The alias helps avoid name collisions if debug_0 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForDebug0(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForDebug0(t *testing.T, data any) map[string]any {
...
func TestParse_Debug0(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "debug_0.ksy")
	ksySchema := loadKsySchemaForDebug0(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for debug_0, skipping detailed parse tests.")

}

func TestSerialize_Debug0(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "debug_0.ksy")
	ksySchema := loadKsySchemaForDebug0(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for debug_0, skipping detailed serialize tests.")
