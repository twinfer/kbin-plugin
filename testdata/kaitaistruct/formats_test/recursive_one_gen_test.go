...
import (
	...
	// The alias helps avoid name collisions if recursive_one is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForRecursiveOne(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForRecursiveOne(t *testing.T, data any) map[string]any {
...
func TestParse_RecursiveOne(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "recursive_one.ksy")
	ksySchema := loadKsySchemaForRecursiveOne(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for recursive_one, skipping detailed parse tests.")

}

func TestSerialize_RecursiveOne(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "recursive_one.ksy")
	ksySchema := loadKsySchemaForRecursiveOne(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for recursive_one, skipping detailed serialize tests.")
