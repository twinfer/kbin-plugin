...
import (
	...
	// The alias helps avoid name collisions if process_xor_const is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForProcessXorConst(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForProcessXorConst(t *testing.T, data any) map[string]any {
...
func TestParse_ProcessXorConst(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_xor_const.ksy")
	ksySchema := loadKsySchemaForProcessXorConst(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for process_xor_const, skipping detailed parse tests.")

}

func TestSerialize_ProcessXorConst(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_xor_const.ksy")
	ksySchema := loadKsySchemaForProcessXorConst(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for process_xor_const, skipping detailed serialize tests.")
