...
import (
	...
	// The alias helps avoid name collisions if expr_bits is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForExprBits(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForExprBits(t *testing.T, data any) map[string]any {
...
func TestParse_ExprBits(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_bits.ksy")
	ksySchema := loadKsySchemaForExprBits(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for expr_bits, skipping detailed parse tests.")

}

func TestSerialize_ExprBits(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_bits.ksy")
	ksySchema := loadKsySchemaForExprBits(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for expr_bits, skipping detailed serialize tests.")
