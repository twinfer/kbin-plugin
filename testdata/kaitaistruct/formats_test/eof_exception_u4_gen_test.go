...
import (
	...
	// The alias helps avoid name collisions if eof_exception_u4 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEofExceptionU4(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEofExceptionU4(t *testing.T, data any) map[string]any {
...
func TestParse_EofExceptionU4(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "eof_exception_u4.ksy")
	ksySchema := loadKsySchemaForEofExceptionU4(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for eof_exception_u4, skipping detailed parse tests.")

}

func TestSerialize_EofExceptionU4(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "eof_exception_u4.ksy")
	ksySchema := loadKsySchemaForEofExceptionU4(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for eof_exception_u4, skipping detailed serialize tests.")
