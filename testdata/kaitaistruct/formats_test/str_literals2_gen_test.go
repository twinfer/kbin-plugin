...
import (
	...
	// The alias helps avoid name collisions if str_literals2 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForStrLiterals2(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForStrLiterals2(t *testing.T, data any) map[string]any {
...
func TestParse_StrLiterals2(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "str_literals2.ksy")
	ksySchema := loadKsySchemaForStrLiterals2(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for str_literals2, skipping detailed parse tests.")
...
func TestSerialize_StrLiterals2(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for str_literals2, skipping detailed serialize tests.")
