...
import (
	...
	// The alias helps avoid name collisions if nested_same_name is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForNestedSameName(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForNestedSameName(t *testing.T, data any) map[string]any {
...
func TestParse_NestedSameName(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nested_same_name.ksy")
	ksySchema := loadKsySchemaForNestedSameName(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for nested_same_name, skipping detailed parse tests.")
...
func TestSerialize_NestedSameName(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for nested_same_name, skipping detailed serialize tests.")
