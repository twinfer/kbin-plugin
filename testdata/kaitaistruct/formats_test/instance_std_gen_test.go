...
import (
	...
	// The alias helps avoid name collisions if instance_std is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForInstanceStd(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForInstanceStd(t *testing.T, data any) map[string]any {
...
func TestParse_InstanceStd(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "instance_std.ksy")
	ksySchema := loadKsySchemaForInstanceStd(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for instance_std, skipping detailed parse tests.")

}

func TestSerialize_InstanceStd(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "instance_std.ksy")
	ksySchema := loadKsySchemaForInstanceStd(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for instance_std, skipping detailed serialize tests.")
