...
import (
	...
	// The alias helps avoid name collisions if enum_import_seq is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEnumImportSeq(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEnumImportSeq(t *testing.T, data any) map[string]any {
...
func TestParse_EnumImportSeq(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_import_seq.ksy")
	ksySchema := loadKsySchemaForEnumImportSeq(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for enum_import_seq, skipping detailed parse tests.")

}

func TestSerialize_EnumImportSeq(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_import_seq.ksy")
	ksySchema := loadKsySchemaForEnumImportSeq(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for enum_import_seq, skipping detailed serialize tests.")
