...
import (
	...
	// The alias helps avoid name collisions if eos_exception_bytes is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEosExceptionBytes(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEosExceptionBytes(t *testing.T, data any) map[string]any {
...
func TestParse_EosExceptionBytes(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "eos_exception_bytes.ksy")
	ksySchema := loadKsySchemaForEosExceptionBytes(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for eos_exception_bytes, skipping detailed parse tests.")

}

func TestSerialize_EosExceptionBytes(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "eos_exception_bytes.ksy")
	ksySchema := loadKsySchemaForEosExceptionBytes(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for eos_exception_bytes, skipping detailed serialize tests.")
