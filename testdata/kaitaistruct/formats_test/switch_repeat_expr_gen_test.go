...
import (
	...
	// The alias helps avoid name collisions if switch_repeat_expr is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForSwitchRepeatExpr(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForSwitchRepeatExpr(t *testing.T, data any) map[string]any {
...
func TestParse_SwitchRepeatExpr(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_repeat_expr.ksy")
	ksySchema := loadKsySchemaForSwitchRepeatExpr(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for switch_repeat_expr, skipping detailed parse tests.")

}

func TestSerialize_SwitchRepeatExpr(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_repeat_expr.ksy")
	ksySchema := loadKsySchemaForSwitchRepeatExpr(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for switch_repeat_expr, skipping detailed serialize tests.")
