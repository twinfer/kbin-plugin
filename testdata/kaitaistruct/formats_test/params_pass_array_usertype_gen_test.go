...
import (
	...
	// The alias helps avoid name collisions if params_pass_array_usertype is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForParamsPassArrayUsertype(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForParamsPassArrayUsertype(t *testing.T, data any) map[string]any {
...
func TestParse_ParamsPassArrayUsertype(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_pass_array_usertype.ksy")
	ksySchema := loadKsySchemaForParamsPassArrayUsertype(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for params_pass_array_usertype, skipping detailed parse tests.")

}

func TestSerialize_ParamsPassArrayUsertype(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_pass_array_usertype.ksy")
	ksySchema := loadKsySchemaForParamsPassArrayUsertype(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for params_pass_array_usertype, skipping detailed serialize tests.")
