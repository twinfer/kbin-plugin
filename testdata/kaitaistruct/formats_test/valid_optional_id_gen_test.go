...
import (
	...
	// The alias helps avoid name collisions if valid_optional_id is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForValidOptionalId(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForValidOptionalId(t *testing.T, data any) map[string]any {
...
func TestParse_ValidOptionalId(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "valid_optional_id.ksy")
	ksySchema := loadKsySchemaForValidOptionalId(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for valid_optional_id, skipping detailed parse tests.")

}

func TestSerialize_ValidOptionalId(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "valid_optional_id.ksy")
	ksySchema := loadKsySchemaForValidOptionalId(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for valid_optional_id, skipping detailed serialize tests.")
