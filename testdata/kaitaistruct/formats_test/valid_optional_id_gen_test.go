...
import (
	...
	valid_optional_id_kaitai "github.com/twinfer/kbin-plugin/testdata/formats_kaitai_go_gen/valid_optional_id"
)

func TestParse_ValidOptionalId(t *testing.T) {
	// Load schema
	ksyPath := filepath.Join("../../../test/formats", "valid_optional_id.ksy")
...
func TestSerialize_ValidOptionalId(t *testing.T) {
	...
	original := valid_optional_id_kaitai.NewValidOptionalId()
	err = original.Read(stream, original, original)
	require.NoError(t, err)

	// Serialize and verify round-trip
	inputMap := structToMapValidOptionalId(t, original)
	...
	reparsed := valid_optional_id_kaitai.NewValidOptionalId()
	...
	cmpOpts := []cmp.Option{
		...
		cmpopts.IgnoreFields(valid_optional_id_kaitai.ValidOptionalId{}, "_io", "_parent", "_root"),
		cmpopts.EquateEmpty(),
	}
...
// structToMapValidOptionalId converts KSC struct to map for serializer
func structToMapValidOptionalId(t *testing.T, data any) map[string]any {
	// Use reflection to handle KSC structs with method-based values
	return structToMapReflectiveValidOptionalId(t, data)
}

// structToMapReflectiveValidOptionalId uses reflection to convert KSC structs including method calls
func structToMapReflectiveValidOptionalId(t *testing.T, data any) map[string]any {
	...
	for i := 0; i < val.NumField(); i++ {
		...
		case reflect.Ptr:
			if !fieldVal.IsNil() {
				...
				subMap := structToMapReflectiveValidOptionalId(t, fieldVal.Interface())
