...
import (
	...
	// The alias helps avoid name collisions if bits_unaligned_b32_be is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForBitsUnalignedB32Be(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForBitsUnalignedB32Be(t *testing.T, data any) map[string]any {
...
func TestParse_BitsUnalignedB32Be(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "bits_unaligned_b32_be.ksy")
	ksySchema := loadKsySchemaForBitsUnalignedB32Be(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for bits_unaligned_b32_be, skipping detailed parse tests.")

}

func TestSerialize_BitsUnalignedB32Be(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "bits_unaligned_b32_be.ksy")
	ksySchema := loadKsySchemaForBitsUnalignedB32Be(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for bits_unaligned_b32_be, skipping detailed serialize tests.")
