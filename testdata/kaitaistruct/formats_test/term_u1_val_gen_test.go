...
import (
	...
	// The alias helps avoid name collisions if term_u1_val is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForTermU1Val(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForTermU1Val(t *testing.T, data any) map[string]any {
...
func TestParse_TermU1Val(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "term_u1_val.ksy")
	ksySchema := loadKsySchemaForTermU1Val(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for term_u1_val, skipping detailed parse tests.")

}

func TestSerialize_TermU1Val(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "term_u1_val.ksy")
	ksySchema := loadKsySchemaForTermU1Val(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for term_u1_val, skipping detailed serialize tests.")
