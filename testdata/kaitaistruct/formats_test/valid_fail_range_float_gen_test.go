...
import (
	...
	// The alias helps avoid name collisions if valid_fail_range_float is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForValidFailRangeFloat(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForValidFailRangeFloat(t *testing.T, data any) map[string]any {
...
func TestParse_ValidFailRangeFloat(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "valid_fail_range_float.ksy")
	ksySchema := loadKsySchemaForValidFailRangeFloat(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for valid_fail_range_float, skipping detailed parse tests.")

}

func TestSerialize_ValidFailRangeFloat(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "valid_fail_range_float.ksy")
	ksySchema := loadKsySchemaForValidFailRangeFloat(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for valid_fail_range_float, skipping detailed serialize tests.")
