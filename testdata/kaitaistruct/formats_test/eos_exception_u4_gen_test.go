...
import (
	...
	// The alias helps avoid name collisions if eos_exception_u4 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEosExceptionU4(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEosExceptionU4(t *testing.T, data any) map[string]any {
...
func TestParse_EosExceptionU4(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "eos_exception_u4.ksy")
	ksySchema := loadKsySchemaForEosExceptionU4(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for eos_exception_u4, skipping detailed parse tests.")

}

func TestSerialize_EosExceptionU4(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "eos_exception_u4.ksy")
	ksySchema := loadKsySchemaForEosExceptionU4(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for eos_exception_u4, skipping detailed serialize tests.")
