...
import (
	...
	// The alias helps avoid name collisions if type_ternary_opaque is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForTypeTernaryOpaque(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForTypeTernaryOpaque(t *testing.T, data any) map[string]any {
...
func TestParse_TypeTernaryOpaque(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "type_ternary_opaque.ksy")
	ksySchema := loadKsySchemaForTypeTernaryOpaque(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for type_ternary_opaque, skipping detailed parse tests.")
...
func TestSerialize_TypeTernaryOpaque(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for type_ternary_opaque, skipping detailed serialize tests.")
