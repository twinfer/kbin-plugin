...
import (
	...
	// The alias helps avoid name collisions if enum_1 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEnum1(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEnum1(t *testing.T, data any) map[string]any {
...
func TestParse_Enum1(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_1.ksy")
	ksySchema := loadKsySchemaForEnum1(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for enum_1, skipping detailed parse tests.")
...
func TestSerialize_Enum1(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for enum_1, skipping detailed serialize tests.")
