...
import (
	...
	// The alias helps avoid name collisions if opaque_external_type is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForOpaqueExternalType(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForOpaqueExternalType(t *testing.T, data any) map[string]any {
...
func TestParse_OpaqueExternalType(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "opaque_external_type.ksy")
	ksySchema := loadKsySchemaForOpaqueExternalType(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for opaque_external_type, skipping detailed parse tests.")

}

func TestSerialize_OpaqueExternalType(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "opaque_external_type.ksy")
	ksySchema := loadKsySchemaForOpaqueExternalType(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for opaque_external_type, skipping detailed serialize tests.")
