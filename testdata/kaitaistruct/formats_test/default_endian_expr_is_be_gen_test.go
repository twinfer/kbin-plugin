...
import (
	...
	// The alias helps avoid name collisions if default_endian_expr_is_be is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForDefaultEndianExprIsBe(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForDefaultEndianExprIsBe(t *testing.T, data any) map[string]any {
...
func TestParse_DefaultEndianExprIsBe(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "default_endian_expr_is_be.ksy")
	ksySchema := loadKsySchemaForDefaultEndianExprIsBe(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for default_endian_expr_is_be, skipping detailed parse tests.")

}

func TestSerialize_DefaultEndianExprIsBe(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "default_endian_expr_is_be.ksy")
	ksySchema := loadKsySchemaForDefaultEndianExprIsBe(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for default_endian_expr_is_be, skipping detailed serialize tests.")
