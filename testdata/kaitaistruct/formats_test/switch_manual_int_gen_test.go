...
import (
	...
	// The alias helps avoid name collisions if switch_manual_int is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForSwitchManualInt(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForSwitchManualInt(t *testing.T, data any) map[string]any {
...
func TestParse_SwitchManualInt(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_manual_int.ksy")
	ksySchema := loadKsySchemaForSwitchManualInt(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for switch_manual_int, skipping detailed parse tests.")

}

func TestSerialize_SwitchManualInt(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_manual_int.ksy")
	ksySchema := loadKsySchemaForSwitchManualInt(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for switch_manual_int, skipping detailed serialize tests.")
