...
import (
	...
	// The alias helps avoid name collisions if type_int_unary_op is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForTypeIntUnaryOp(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForTypeIntUnaryOp(t *testing.T, data any) map[string]any {
...
func TestParse_TypeIntUnaryOp(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "type_int_unary_op.ksy")
	ksySchema := loadKsySchemaForTypeIntUnaryOp(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for type_int_unary_op, skipping detailed parse tests.")

}

func TestSerialize_TypeIntUnaryOp(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "type_int_unary_op.ksy")
	ksySchema := loadKsySchemaForTypeIntUnaryOp(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for type_int_unary_op, skipping detailed serialize tests.")
