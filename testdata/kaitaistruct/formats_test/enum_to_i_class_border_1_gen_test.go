...
import (
	...
	// The alias helps avoid name collisions if enum_to_i_class_border_1 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEnumToIClassBorder1(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEnumToIClassBorder1(t *testing.T, data any) map[string]any {
...
func TestParse_EnumToIClassBorder1(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_to_i_class_border_1.ksy")
	ksySchema := loadKsySchemaForEnumToIClassBorder1(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for enum_to_i_class_border_1, skipping detailed parse tests.")

}

func TestSerialize_EnumToIClassBorder1(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_to_i_class_border_1.ksy")
	ksySchema := loadKsySchemaForEnumToIClassBorder1(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for enum_to_i_class_border_1, skipping detailed serialize tests.")
