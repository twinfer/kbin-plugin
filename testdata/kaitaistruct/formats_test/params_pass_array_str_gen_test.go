...
import (
	...
	// The alias helps avoid name collisions if params_pass_array_str is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForParamsPassArrayStr(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForParamsPassArrayStr(t *testing.T, data any) map[string]any {
...
func TestParse_ParamsPassArrayStr(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_pass_array_str.ksy")
	ksySchema := loadKsySchemaForParamsPassArrayStr(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for params_pass_array_str, skipping detailed parse tests.")

}

func TestSerialize_ParamsPassArrayStr(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "params_pass_array_str.ksy")
	ksySchema := loadKsySchemaForParamsPassArrayStr(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for params_pass_array_str, skipping detailed serialize tests.")
