...
import (
	...
	// The alias helps avoid name collisions if expr_to_i_trailing is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForExprToITrailing(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForExprToITrailing(t *testing.T, data any) map[string]any {
...
func TestParse_ExprToITrailing(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_to_i_trailing.ksy")
	ksySchema := loadKsySchemaForExprToITrailing(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for expr_to_i_trailing, skipping detailed parse tests.")

}

func TestSerialize_ExprToITrailing(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_to_i_trailing.ksy")
	ksySchema := loadKsySchemaForExprToITrailing(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for expr_to_i_trailing, skipping detailed serialize tests.")
