...
import (
	...
	// The alias helps avoid name collisions if expr_io_eof is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForExprIoEof(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForExprIoEof(t *testing.T, data any) map[string]any {
...
func TestParse_ExprIoEof(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_io_eof.ksy")
	ksySchema := loadKsySchemaForExprIoEof(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for expr_io_eof, skipping detailed parse tests.")

}

func TestSerialize_ExprIoEof(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "expr_io_eof.ksy")
	ksySchema := loadKsySchemaForExprIoEof(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for expr_io_eof, skipping detailed serialize tests.")
