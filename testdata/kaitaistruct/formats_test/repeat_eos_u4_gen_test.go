...
import (
	...
	// The alias helps avoid name collisions if repeat_eos_u4 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForRepeatEosU4(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForRepeatEosU4(t *testing.T, data any) map[string]any {
...
func TestParse_RepeatEosU4(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "repeat_eos_u4.ksy")
	ksySchema := loadKsySchemaForRepeatEosU4(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for repeat_eos_u4, skipping detailed parse tests.")

}

func TestSerialize_RepeatEosU4(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "repeat_eos_u4.ksy")
	ksySchema := loadKsySchemaForRepeatEosU4(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for repeat_eos_u4, skipping detailed serialize tests.")
