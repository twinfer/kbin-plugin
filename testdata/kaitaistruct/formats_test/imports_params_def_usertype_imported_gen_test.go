...
import (
	...
	// The alias helps avoid name collisions if imports_params_def_usertype_imported is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForImportsParamsDefUsertypeImported(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForImportsParamsDefUsertypeImported(t *testing.T, data any) map[string]any {
...
func TestParse_ImportsParamsDefUsertypeImported(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "imports_params_def_usertype_imported.ksy")
	ksySchema := loadKsySchemaForImportsParamsDefUsertypeImported(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for imports_params_def_usertype_imported, skipping detailed parse tests.")
...
func TestSerialize_ImportsParamsDefUsertypeImported(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for imports_params_def_usertype_imported, skipping detailed serialize tests.")
