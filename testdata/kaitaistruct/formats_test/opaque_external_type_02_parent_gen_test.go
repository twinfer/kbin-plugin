...
import (
	...
	// The alias helps avoid name collisions if opaque_external_type_02_parent is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForOpaqueExternalType02Parent(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForOpaqueExternalType02Parent(t *testing.T, data any) map[string]any {
...
func TestParse_OpaqueExternalType02Parent(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "opaque_external_type_02_parent.ksy")
	ksySchema := loadKsySchemaForOpaqueExternalType02Parent(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for opaque_external_type_02_parent, skipping detailed parse tests.")
...
func TestSerialize_OpaqueExternalType02Parent(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for opaque_external_type_02_parent, skipping detailed serialize tests.")
