...
import (
	...
	// The alias helps avoid name collisions if default_endian_expr_inherited is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForDefaultEndianExprInherited(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForDefaultEndianExprInherited(t *testing.T, data any) map[string]any {
...
func TestParse_DefaultEndianExprInherited(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "default_endian_expr_inherited.ksy")
	ksySchema := loadKsySchemaForDefaultEndianExprInherited(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for default_endian_expr_inherited, skipping detailed parse tests.")

}

func TestSerialize_DefaultEndianExprInherited(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "default_endian_expr_inherited.ksy")
	ksySchema := loadKsySchemaForDefaultEndianExprInherited(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for default_endian_expr_inherited, skipping detailed serialize tests.")
