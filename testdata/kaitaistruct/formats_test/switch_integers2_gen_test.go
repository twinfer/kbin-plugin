...
import (
	...
	// The alias helps avoid name collisions if switch_integers2 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForSwitchIntegers2(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForSwitchIntegers2(t *testing.T, data any) map[string]any {
...
func TestParse_SwitchIntegers2(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_integers2.ksy")
	ksySchema := loadKsySchemaForSwitchIntegers2(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for switch_integers2, skipping detailed parse tests.")
...
func TestSerialize_SwitchIntegers2(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for switch_integers2, skipping detailed serialize tests.")
