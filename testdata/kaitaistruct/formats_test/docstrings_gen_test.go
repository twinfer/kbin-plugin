...
import (
	...
	// The alias helps avoid name collisions if docstrings is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForDocstrings(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForDocstrings(t *testing.T, data any) map[string]any {
...
func TestParse_Docstrings(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "docstrings.ksy")
	ksySchema := loadKsySchemaForDocstrings(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for docstrings, skipping detailed parse tests.")

}

func TestSerialize_Docstrings(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "docstrings.ksy")
	ksySchema := loadKsySchemaForDocstrings(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for docstrings, skipping detailed serialize tests.")
