...
import (
	...
	// The alias helps avoid name collisions if default_bit_endian_mod is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForDefaultBitEndianMod(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForDefaultBitEndianMod(t *testing.T, data any) map[string]any {
...
func TestParse_DefaultBitEndianMod(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "default_bit_endian_mod.ksy")
	ksySchema := loadKsySchemaForDefaultBitEndianMod(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for default_bit_endian_mod, skipping detailed parse tests.")
...
func TestSerialize_DefaultBitEndianMod(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for default_bit_endian_mod, skipping detailed serialize tests.")
