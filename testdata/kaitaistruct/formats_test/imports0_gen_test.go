...
import (
	...
	// The alias helps avoid name collisions if imports0 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForImports0(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForImports0(t *testing.T, data any) map[string]any {
...
func TestParse_Imports0(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "imports0.ksy")
	ksySchema := loadKsySchemaForImports0(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for imports0, skipping detailed parse tests.")
...
func TestSerialize_Imports0(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for imports0, skipping detailed serialize tests.")
