...
import (
	...
	// The alias helps avoid name collisions if enum_to_i_class_border_2 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEnumToIClassBorder2(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEnumToIClassBorder2(t *testing.T, data any) map[string]any {
...
func TestParse_EnumToIClassBorder2(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_to_i_class_border_2.ksy")
	ksySchema := loadKsySchemaForEnumToIClassBorder2(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for enum_to_i_class_border_2, skipping detailed parse tests.")

}

func TestSerialize_EnumToIClassBorder2(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_to_i_class_border_2.ksy")
	ksySchema := loadKsySchemaForEnumToIClassBorder2(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for enum_to_i_class_border_2, skipping detailed serialize tests.")
