...
import (
	...
	// The alias helps avoid name collisions if nested_types2 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForNestedTypes2(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForNestedTypes2(t *testing.T, data any) map[string]any {
...
func TestParse_NestedTypes2(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nested_types2.ksy")
	ksySchema := loadKsySchemaForNestedTypes2(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for nested_types2, skipping detailed parse tests.")
...
func TestSerialize_NestedTypes2(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for nested_types2, skipping detailed serialize tests.")
