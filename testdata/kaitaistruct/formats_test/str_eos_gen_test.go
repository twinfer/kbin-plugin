...
import (
	...
	// The alias helps avoid name collisions if str_eos is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForStrEos(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForStrEos(t *testing.T, data any) map[string]any {
...
func TestParse_StrEos(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "str_eos.ksy")
	ksySchema := loadKsySchemaForStrEos(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for str_eos, skipping detailed parse tests.")

}

func TestSerialize_StrEos(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "str_eos.ksy")
	ksySchema := loadKsySchemaForStrEos(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for str_eos, skipping detailed serialize tests.")
