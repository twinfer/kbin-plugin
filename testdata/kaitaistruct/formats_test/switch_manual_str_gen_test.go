...
import (
	...
	// The alias helps avoid name collisions if switch_manual_str is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForSwitchManualStr(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForSwitchManualStr(t *testing.T, data any) map[string]any {
...
func TestParse_SwitchManualStr(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_manual_str.ksy")
	ksySchema := loadKsySchemaForSwitchManualStr(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for switch_manual_str, skipping detailed parse tests.")

}

func TestSerialize_SwitchManualStr(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "switch_manual_str.ksy")
	ksySchema := loadKsySchemaForSwitchManualStr(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for switch_manual_str, skipping detailed serialize tests.")
