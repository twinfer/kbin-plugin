...
import (
	...
	// The alias helps avoid name collisions if yaml_ints is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForYamlInts(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForYamlInts(t *testing.T, data any) map[string]any {
...
func TestParse_YamlInts(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "yaml_ints.ksy")
	ksySchema := loadKsySchemaForYamlInts(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for yaml_ints, skipping detailed parse tests.")
...
func TestSerialize_YamlInts(t *testing.T) {
	...
	_ = serializer
	t.Logf("No binary test cases for yaml_ints, skipping detailed serialize tests.")
