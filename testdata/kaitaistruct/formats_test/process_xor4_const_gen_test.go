...
import (
	...
	// The alias helps avoid name collisions if process_xor4_const is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForProcessXor4Const(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForProcessXor4Const(t *testing.T, data any) map[string]any {
...
func TestParse_ProcessXor4Const(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_xor4_const.ksy")
	ksySchema := loadKsySchemaForProcessXor4Const(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for process_xor4_const, skipping detailed parse tests.")

}

func TestSerialize_ProcessXor4Const(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "process_xor4_const.ksy")
	ksySchema := loadKsySchemaForProcessXor4Const(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for process_xor4_const, skipping detailed serialize tests.")
