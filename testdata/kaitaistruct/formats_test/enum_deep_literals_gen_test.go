...
import (
	...
	// The alias helps avoid name collisions if enum_deep_literals is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEnumDeepLiterals(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEnumDeepLiterals(t *testing.T, data any) map[string]any {
...
func TestParse_EnumDeepLiterals(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_deep_literals.ksy")
	ksySchema := loadKsySchemaForEnumDeepLiterals(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for enum_deep_literals, skipping detailed parse tests.")

}

func TestSerialize_EnumDeepLiterals(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "enum_deep_literals.ksy")
	ksySchema := loadKsySchemaForEnumDeepLiterals(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for enum_deep_literals, skipping detailed serialize tests.")
