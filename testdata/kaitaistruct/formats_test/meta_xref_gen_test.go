...
import (
	...
	// The alias helps avoid name collisions if meta_xref is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForMetaXref(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForMetaXref(t *testing.T, data any) map[string]any {
...
func TestParse_MetaXref(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "meta_xref.ksy")
	ksySchema := loadKsySchemaForMetaXref(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for meta_xref, skipping detailed parse tests.")

}

func TestSerialize_MetaXref(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "meta_xref.ksy")
	ksySchema := loadKsySchemaForMetaXref(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for meta_xref, skipping detailed serialize tests.")
