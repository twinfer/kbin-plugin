...
import (
	...
	// The alias helps avoid name collisions if eof_exception_bytes is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForEofExceptionBytes(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForEofExceptionBytes(t *testing.T, data any) map[string]any {
...
func TestParse_EofExceptionBytes(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "eof_exception_bytes.ksy")
	ksySchema := loadKsySchemaForEofExceptionBytes(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for eof_exception_bytes, skipping detailed parse tests.")

}

func TestSerialize_EofExceptionBytes(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "eof_exception_bytes.ksy")
	ksySchema := loadKsySchemaForEofExceptionBytes(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for eof_exception_bytes, skipping detailed serialize tests.")
