...
import (
	...
	// The alias helps avoid name collisions if nested_types3 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForNestedTypes3(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForNestedTypes3(t *testing.T, data any) map[string]any {
...
func TestParse_NestedTypes3(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nested_types3.ksy")
	ksySchema := loadKsySchemaForNestedTypes3(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for nested_types3, skipping detailed parse tests.")

}

func TestSerialize_NestedTypes3(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "nested_types3.ksy")
	ksySchema := loadKsySchemaForNestedTypes3(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for nested_types3, skipping detailed serialize tests.")
