...
import (
	...
	// The alias helps avoid name collisions if term_strz_utf16_v2 is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForTermStrzUtf16V2(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForTermStrzUtf16V2(t *testing.T, data any) map[string]any {
...
func TestParse_TermStrzUtf16V2(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "term_strz_utf16_v2.ksy")
	ksySchema := loadKsySchemaForTermStrzUtf16V2(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for term_strz_utf16_v2, skipping detailed parse tests.")

}

func TestSerialize_TermStrzUtf16V2(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "term_strz_utf16_v2.ksy")
	ksySchema := loadKsySchemaForTermStrzUtf16V2(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for term_strz_utf16_v2, skipping detailed serialize tests.")
