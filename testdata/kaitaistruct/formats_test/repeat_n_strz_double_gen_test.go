...
import (
	...
	// The alias helps avoid name collisions if repeat_n_strz_double is a common word.
)

// loadKsySchema is a helper to load a .ksy file for the interpreter.
// It's defined once per generated test file.
func loadKsySchemaForRepeatNStrzDouble(t *testing.T, ksyPath string) *kaitaistruct.KaitaiSchema {
...
func structToMapForSerializerForRepeatNStrzDouble(t *testing.T, data any) map[string]any {
...
func TestParse_RepeatNStrzDouble(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "repeat_n_strz_double.ksy")
	ksySchema := loadKsySchemaForRepeatNStrzDouble(t, ksyFilePath)
	...
	_ = interpreter
	t.Logf("No binary test cases for repeat_n_strz_double, skipping detailed parse tests.")

}

func TestSerialize_RepeatNStrzDouble(t *testing.T) {
	ksyFilePath := filepath.Join("../../../test/formats", "repeat_n_strz_double.ksy")
	ksySchema := loadKsySchemaForRepeatNStrzDouble(t, ksyFilePath)
	...
	_ = serializer
	t.Logf("No binary test cases for repeat_n_strz_double, skipping detailed serialize tests.")
